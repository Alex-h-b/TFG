...
top_goleadores_pred = pd.read_csv("C:/Users/ALex/Desktop/Uni/4/2o_Cuatri/TFG/top_goles_predichos_xgboost.csv")
...
top_asistentes_pred = pd.read_csv("C:/Users/ALex/Desktop/Uni/4/2o_Cuatri/TFG/top_asistentes_predichas_25_26.csv")
...
app_ui = ui.page_navbar(
    ...
    ui.nav_panel("Mi aplicación",
        ...
        """),
        ui.p("""
        A través de la sección "📊 Análisis de Competiciones", puedes examinar estadísticas detalladas de equipos y partidos reales, incluyendo mapas de tiros, redes de pases, recuperaciones y goles. 
        """),
        ui.p("""
        En "🧍 Análisis de Jugadores", puedes descubrir los mejores jugadores por métrica, generar gráficos radar o pizza según la posición, comparar atributos y predecir su rendimiento en la siguiente temporada mediante modelos de aprendizaje automático. Además, la sección de "🔎 Buscador" permite filtrar jugadores por posición, edad y métricas clave para encontrar perfiles específicos, ideal para scouting o análisis técnico.
        """),
        ui.p("""
         Finalmente, en el apartado de "🎥🧠 Visión por Computadora", se visualizan ejemplos prácticos del uso de inteligencia artificial para rastrear jugadores, analizar posturas y extraer información táctica a partir de vídeo.
        """),
        ui.p("""
